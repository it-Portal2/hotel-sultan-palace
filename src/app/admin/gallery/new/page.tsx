...
export default function NewGalleryImagePage() {
  ...
  const handleUpload = async (file: File) => {
    ...
    try {
      ...
      const obj = storageRef(storage, `gallery/${key}/${fileName}`);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (id) {
        ...
        showToast('Failed to create gallery image. Please try again.', 'error');
      }
              ...
              <Image 
                ...
                onError={(e) => {
                  ...
                  if (parent) {
                    ...
                    errorDiv.className = 'w-full max-w-xl h-64 rounded-lg border-2 border-red-300 bg-red-50 flex items-center justify-center';
