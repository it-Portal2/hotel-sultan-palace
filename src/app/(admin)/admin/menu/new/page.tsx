    ...
    <div className="space-y-6 pb-20">
      ...
      <form onSubmit={handleSubmit} className="bg-white rounded-xl shadow-lg p-6 border border-gray-100 space-y-8">
        ...
        <div className="mt-6 flex gap-3">
          ...
          <button type="submit" disabled={loading} className="px-6 py-2 bg-[#FF6A00] text-white rounded-lg hover:bg-[#FF6A00]/90 disabled:opacity-50">{loading ? 'Creating...' : 'Create Menu Item'}</button>
        </div>
      </form>
    </div>
  );
