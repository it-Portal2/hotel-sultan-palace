...
export default function AdminRoomTypesPage() {
  ...
  const performDelete = async () => {
    ...
    try {
      await deleteRoomType(confirmDeleteId);
        ...
        <div className="bg-white p-6 border border-gray-200 shadow-sm">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex gap-3">
              <button
                type="submit"
                className="px-4 py-2 bg-[#FF6A00] text-white hover:bg-[#FF6A00]/90 transition-colors"
              >
            ...
            {types.length === 0 ? (
              ...
              <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-6 lg:grid-cols-8 gap-3">
                {types.map(rt => (
                  <div
                    key={rt.id}
                    className={`p-3 border border-gray-200 hover:border-[#FF6A00] transition-all bg-white ${!rt.isActive ? 'opacity-60' : ''
                      }`}
                  >
                        ...
                        {isReadOnly ? (
                          ...
                          <>
                            <button
                              ...
                              className={`p-1 transition-colors ${rt.isActive ? 'text-green-600 hover:bg-green-50' : 'text-gray-400 hover:bg-gray-100'
                                }`}
                            ...
                            <button
                              ...
                              className="p-1 text-[#FF6A00] hover:bg-orange-50 transition-colors"
                              title="Edit"
                            >
                    ...
                    <div className={`text-xs px-2 py-0.5 text-center ${rt.isActive ? 'bg-green-100 text-green-700' : 'bg-gray-100 text-gray-600'
                      }`}>
