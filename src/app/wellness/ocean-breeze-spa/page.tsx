...
export default function OceanBreezeSpaPage() {
  return (
    <>
      ...
      {/* Hero */}
      <section className="relative w-full h-[680px] md:h-[800px] lg:h-[1018px] overflow-hidden">
        <Image
          src="/spa_hero.png"
        ...
        <div className="absolute left-1/2 -translate-x-1/2 bottom-4 md:bottom-2 w-full px-6 md:px-10">
          <div className="mx-auto max-w-[700px] text-center">
            <h1 className="text-[#554019] text-xl md:text-2xl lg:text-[24px] font-semibold leading-[27px] mb-3 md:py-[20px]">
              Where the Ocean Breeze Meets Total Relaxation
            </h1>
            <p className="text-[#423B2D] text-sm md:text-[16px] leading-[27px] text-center">
        ...
        <div className="relative z-10 px-6 md:px-16">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-[23px] justify-items-center">
            {[
              ...
              <div key={i} className="w-full max-w-[341px] h-[580px] md:h-[628px] overflow-hidden">
                ...
                <div className="py-[10px] flex flex-col items-center">
                  <h3 className="text-[#2A2824] text-lg md:text-[20px] font-semibold leading-[27px] text-center py-[10px] px-2">{treatment.title}</h3>
                  <p className="text-[#655D4E] text-sm md:text-[16px] leading-[27px] text-center max-w-[280px] md:max-w-[332px] px-2">{treatment.desc}</p>
                </div>
              </div>
            ))}
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-6 md:gap-10 mt-8 md:mt-0">
            <div className="relative w-full h-[400px] md:h-[700px] order-2 md:order-1">
            ...
            <div className="relative max-w-[500px] mx-auto text-center order-1 md:order-2 px-4">
              ...
              <Link
                href="#treatments"
                className="inline-flex items-center gap-3 bg-[#FF6A00] hover:opacity-95 transition-opacity text-white px-6 py-3 rounded-[10px] text-sm md:text-[16px] font-semibold mt-[32px] shadow-[0_4px_12px_rgba(0,0,0,0.2)]"
      ...
      <section className="relative mt-0">
        <div className="relative w-full h-[400px] md:h-[672px]">
          <Image src="/spa_video_bg.png" alt="Video Background" fill className="object-cover" />
          <div className="absolute inset-0 bg-black/20"></div>
        </div>
        <button
          aria-label="Play Spa Video"
          className="absolute left-1/2 -translate-x-1/2 -translate-y-1/2 top-1/2 w-[60px] h-[60px] md:w-[72px] md:h-[72px] rounded-full bg-white/90 grid place-items-center shadow-md"
        >
