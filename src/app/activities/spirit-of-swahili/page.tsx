      ...
      <main className="min-h-screen bg-[#FFFCF6] font-open-sans">
        ...
        <section className="relative w-full h-[560px] md:h-[700px] lg:h-[928px] overflow-hidden">
          ...
          <div className="absolute inset-0 z-10 flex items-end justify-center pb-10 md:pb-14 lg:pb-16">
            <div className="w-full max-w-[1120px] px-6 text-center space-y-4">
              <h1 className="text-[#2D2922] text-[26px] md:text-[32px] lg:text-[36px] font-semibold leading-[1.25] font-open-sans">
                Where Culture Meets Coastal Elegance
              </h1>
              <p className="text-[#1A1711] text-[14px] md:text-[16px] lg:text-[18px] font-normal leading-[1.68] font-open-sans max-w-[742px] mx-auto">
        ...
        <section className="relative z-30 py-2 md:py-4 mb-10 md:mb-16 lg:mb-20">
          <div className="max-w-[1400px] mx-auto px-4 md:px-6">
            <h2 className="text-[#2C271D] text-[24px] md:text-[24px] font-semibold -mt-20 font-open-sans text-center">
        ...
        <section className="relative z-20 pt-2 md:pt-3 pb-1">
          <div className="max-w-[1400px] mx-auto px-4 md:px-6">
            <h2 className="text-[#FF6A00] text-[18px] md:text-[20px] lg:text-[22px] font-semibold leading-[1.2] text-center font-open-sans">
        ...
        <section className="relative z-10 py-12 overflow-visible">
          ...
          <div className="relative z-10 max-w-[1400px]">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8 mb-8 lg:mb-12">
              <div className="relative rounded-r-[14px] overflow-hidden">
                <div className="relative w-full h-[400px] md:h-[500px] lg:h-[524px]">
                  <Image src="/spirit/spirit-card1-left-2a13ac.png" alt="Red Colobus Monkeys" fill className="object-cover " />
                </div>
              </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8 mb-8 lg:mb-12">
              ...
              <div className="relative rounded-l-[14px] overflow-hidden order-1 lg:order-2 lg:-mt-[120px]">
                <div className="relative w-full h-[400px] md:h-[500px] lg:h-[524px]">
                  <Image src="/spirit/spirit-card1-right.png" alt="Traditional Art" fill className="object-cover " />
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="relative z-10 overflow-hidden ">
          ...
          <div className="relative z-10 max-w-[1400px] ">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8 mb-15 lg:mb-20">
              <div className="relative rounded-r-[14px] overflow-hidden lg:-mt-[60px]">
                <div className="relative w-full h-[400px] md:h-[500px] lg:h-[524px]">
                  <Image src="/spirit/spirit-card2-left-c71919.png" alt="Spice Island Adventures" fill className="object-cover " />
                </div>
              </div>
              <div className="flex items-center">
              <div className="flex items-center order-2 lg:order-1">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8 mb-8 lg:mb-12">
              ...
              <div className="relative rounded-l-[14px] overflow-hidden order-1 lg:order-2 lg:-mt-[120px]">
                <div className="relative w-full h-[400px] md:h-[500px] lg:h-[524px]">
                  <Image src="/spirit/spirit-card2-right.png" alt="Traditional Handicrafts & Art" fill className="object-cover " />
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="relative w-full py-12 md:py-16 lg:py-20 -mt-20 overflow-hidden">
        ...
        <section className="relative w-full h-[520px] md:h-[620px] lg:h-[769px] overflow-hidden">
