                  ...
                  <div key={guest.id} className="border rounded-lg p-4 mb-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <select
                        value={guest.prefix}
                        onChange={(e) =>
                          updateGuest(guest.id, "prefix", e.target.value)
                        }
                      ...
                      <input
                        ...
                        value={guest.mobile}
                        onChange={(e) =>
                          updateGuest(guest.id, "mobile", e.target.value)
                        }
                        className="w-full p-2 border border-gray-300 rounded-md"
                      />
                      <input
                        ...
                        className="w-full p-2 border border-gray-300 rounded-md md:col-span-2"
                      />
                    </div>
                  </div>
                ))}
