  ...
  return (
    <section className="relative overflow-hidden min-h-[900px]">
      ...
      <div className="relative max-w-5xl mx-auto px-4 md:px-6 py-16 md:py-24 flex flex-col items-center text-center">
        ...
        <Link href="/contact-us" className="mt-8 inline-flex items-center justify-center bg-[#F96406] text-white font-quicksand text-[22px] px-6 py-2 rounded-[52px] hover:opacity-90 transition-opacity">
          Connect Us
        </Link>
      </div>
    </section>
