    ...
    <section className="w-full overflow-hidden">
      <div className="grid grid-cols-1 lg:grid-cols-2">
        ...
        <div className="bg-[#FFFCF6] px-4 md:px-6 lg:px-10 xl:px-16 2xl:px-20 py-8 md:py-12 lg:py-16 xl:py-20 2xl:py-24 flex flex-col items-center text-center">
          <FaQuoteLeft className="text-[#22170B]/90 text-2xl md:text-3xl lg:text-4xl" />
          <p className="mt-4 md:mt-5 lg:mt-6 text-[#BE8C53] font-kaisei text-sm md:text-base lg:text-lg">
            voice from our guests
          </p>
          <h2 className="mt-4 md:mt-5 lg:mt-6 font-kaisei font-bold tracking-wide text-2xl md:text-3xl lg:text-4xl xl:text-5xl 2xl:text-[56px] text-[#202C3B]">
            TESTIMONIALS
          </h2>
          ...
          {loading ? (
            ...
            <>
              <p className="mt-8 md:mt-10 lg:mt-12 text-base md:text-lg lg:text-xl xl:text-2xl max-w-3xl text-[#202C3B]/90 font-kaisei leading-relaxed md:leading-8 lg:leading-9">
                {testimonial.text}
              </p>

              <div className="mt-6 md:mt-8 lg:mt-10 flex flex-col sm:flex-row items-center justify-center gap-4 md:gap-6">
      ...
      {/* Ratings bar */}
      <div className="bg-[#242424] py-4 md:py-6 lg:py-8 xl:py-10">
