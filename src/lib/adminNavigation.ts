...
// Portal Types
export type PortalType = 'selection' | 'operations' | 'kitchen' | 'website' | 'finance' | 'staff';
...
export const portalNavigationGroups: Record<PortalType, NavigationGroup[]> = {
    ...
    operations: [
        ...
        },
        {
            ...
            items: [
                { name: 'All Bookings', href: '/admin/bookings', icon: CalendarDaysIcon, color: 'text-purple-500', bgColor: 'bg-purple-50', section: 'bookings' },
                { name: 'Room Availability', href: '/admin/room-availability', icon: CalendarDaysIcon, color: 'text-blue-500', bgColor: 'bg-blue-50', section: 'room_availability' },
                { name: 'Room View', href: '/admin/front-desk?tab=room_view', icon: RectangleStackIcon, color: 'text-green-500', bgColor: 'bg-green-50', section: 'room_view' },
...

        {
            ...
            items: [
                { name: 'Room List', href: '/admin/rooms', icon: BuildingOfficeIcon, color: 'text-blue-500', bgColor: 'bg-blue-50', section: 'rooms_list' },
                { name: 'Add-ons', href: '/admin/addons', icon: PlusIcon, color: 'text-green-500', bgColor: 'bg-green-50', section: 'addons' },
                { name: 'Room Types', href: '/admin/room-types', icon: BuildingOfficeIcon, color: 'text-emerald-500', bgColor: 'bg-emerald-50', section: 'room_types' },
            ],
            defaultOpen: true
        },
        {
            ...
            items: [
                ...
                { name: 'POS', href: '/admin/cashiering?tab=pos', icon: CreditCardIcon, color: 'text-purple-600', bgColor: 'bg-purple-50', section: 'pos' }, // Assuming 'companies' section access or appropriate existing one
            ],
            defaultOpen: true
        },
...

        {
            ...
            icon: CleaningIcon,
            items: [
                { name: 'House Status', href: '/admin/housekeeping?tab=house-status', icon: HomeStatusIcon, color: 'text-teal-600', bgColor: 'bg-teal-50', section: 'house status' },
                { name: 'Maintenance Block', href: '/admin/housekeeping?tab=maintenance-block', icon: WrenchIcon, color: 'text-orange-600', bgColor: 'bg-orange-50', section: 'maintenance block' },
                { name: 'Work Order', href: '/admin/housekeeping?tab=work-order', icon: ClipboardDocumentListIcon, color: 'text-blue-600', bgColor: 'bg-blue-50', section: 'work order' },
            ],
            defaultOpen: true,
            isSingleItem: false
        },
...

        {
            ...
            icon: ClipboardDocumentListIcon,
            items: [
                { name: 'Overview', href: '/admin/inventory?tab=overview', icon: Squares2X2Icon, color: 'text-indigo-600', bgColor: 'bg-indigo-50', section: 'inventory_overview' },
                { name: 'Items', href: '/admin/inventory?tab=items', icon: ListBulletIcon, color: 'text-blue-600', bgColor: 'bg-blue-50', section: 'inventory_items' },
    ...
    kitchen: [
        ...
        },
        {
            ...
            icon: ClipboardDocumentListIcon,
            items: [
                { name: 'Menu Items', href: '/admin/menu', icon: BeakerIcon, color: 'text-rose-500', bgColor: 'bg-rose-50', section: 'menu_items' },
                { name: 'Recipes / Costing', href: '/admin/menu/recipes', icon: BeakerIcon, color: 'text-purple-500', bgColor: 'bg-purple-50', section: 'menu_recipes' },
            ],
            defaultOpen: true,
    ...
    website: [

        {
            ...
            icon: PhotoIcon,
            items: [
                { name: 'Gallery', href: '/admin/gallery', icon: RectangleStackIcon, color: 'text-cyan-500', bgColor: 'bg-cyan-50', section: 'gallery' },
                { name: 'Story Pictures', href: '/admin/story-pictures', icon: FilmIcon, color: 'text-amber-500', bgColor: 'bg-amber-50', section: 'story pictures' },
                { name: 'Excursions', href: '/admin/excursions', icon: MapPinIcon, color: 'text-yellow-500', bgColor: 'bg-yellow-50', section: 'excursions' },
            ],
            defaultOpen: true
        },
        {
            ...
            icon: TagIcon,
            items: [
                { name: 'Offers', href: '/admin/offers', icon: TagIcon, color: 'text-red-500', bgColor: 'bg-red-50', section: 'offers' },
                { name: 'Testimonials', href: '/admin/testimonials', icon: ChatBubbleLeftRightIcon, color: 'text-pink-500', bgColor: 'bg-pink-50', section: 'testimonials' },
                { name: 'Reputation', href: '/admin/reputation-management', icon: StarIcon, color: 'text-blue-500', bgColor: 'bg-blue-50', section: 'reputation' },
            ],
            defaultOpen: true
        },
        {
            ...
            icon: EnvelopeIcon,
            items: [
                { name: 'Contact Msgs', href: '/admin/contacts', icon: EnvelopeIcon, color: 'text-indigo-500', bgColor: 'bg-indigo-50', section: 'contact msgs' },
                { name: 'Booking Enquiries', href: '/admin/booking-enquiries', icon: PhoneIcon, color: 'text-teal-500', bgColor: 'bg-teal-50', section: 'booking enquiries' },
            ],
            defaultOpen: true
        },
    ],
    ...
    staff: [
        {
            ...
            icon: UserGroupIcon,
            items: [
                { name: 'Staff Directory', href: '/admin/staff', icon: UserGroupIcon, color: 'text-cyan-600', bgColor: 'bg-cyan-50', section: 'directory' },
            ],
            defaultOpen: true,
            isSingleItem: true
        },
        {
            ...
            items: [
                { name: 'Roles & Permissions', href: '/admin/roles', icon: ShieldCheckIcon, color: 'text-orange-600', bgColor: 'bg-orange-50', section: 'roles_permissions' },
            ],
            defaultOpen: true,
            isSingleItem: true
        },
        {
            ...
            icon: KeyIcon,
            items: [
                { name: 'System Users', href: '/admin/users', icon: KeyIcon, color: 'text-gray-600', bgColor: 'bg-gray-50', section: 'system_users' },
            ],
            defaultOpen: true,
            isSingleItem: true
        },
